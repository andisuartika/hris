        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarMasterData">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Instansi / Perusahaan</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Lokasi Kantor (GPS)</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Departemen / Divisi</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Posisi & Jabatan</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarEmployees">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Catatan Resign/Keluar</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarAttendance">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Log Kehadiran Harian</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Pengajuan Lembur</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Jadwal Kerja (Shift)</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Hari Libur Nasional</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarLeave">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Pengajuan Cuti</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Persetujuan (Approval)</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Saldo Cuti Pegawai</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Pengaturan Tipe Cuti</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarPayroll">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Proses Gaji Bulanan</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Komponen Gaji</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Slip Gaji Pegawai</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarSettings">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Setting Absensi (Face/GPS)</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Pengguna (Users)</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="#">Peran & Hak Akses</a>
                        </li>
                    </ul>
                </div>
            </li>
